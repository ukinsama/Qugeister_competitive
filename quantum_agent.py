...
class QuantumAgent(BaseAI):
    ...
    def __init__(self, player_id: str, n_qubits=6, n_layers=3, learning_rate=0.01):
        ...
        # パフォーマンス記録
        self.training_history = {"episodes": [], "rewards": [], "losses": [], "epsilon_values": []}
    ...
    def _setup_quantum_circuit(self):
        ...
        self.optimizer = optim.Adam(
            [self.params] + list(self.input_encoder.parameters()) + list(self.output_decoder.parameters()),
    ...
    def _setup_classical_fallback(self):
        ...
        self.network = nn.Sequential(
            nn.Linear(36, 64), nn.ReLU(), nn.Linear(64, 32), nn.ReLU(), nn.Linear(32, 16), nn.ReLU(), nn.Linear(16, 4)
        )
