...
class QuantumAI(BaseAI):
    ...
    def _encode_escape_features(self, game_state):
        ...
        escape_features.append(opponent_min_distance / 10.0 if opponent_min_distance != float("inf") else 1.0)
...
def train_quantum_ai(quantum_ai, opponent, episodes=500):
    ...
    stats = {"episode_rewards": [], "win_rates": [], "losses": [], "escape_victories": 0}
...
def evaluate_performance(quantum_ai, opponents, games_per_opponent=50):
    ...
    for opponent in opponents:
        ...
        results[opponent.name] = {"win_rate": win_rate, "escape_rate": escape_rate}
