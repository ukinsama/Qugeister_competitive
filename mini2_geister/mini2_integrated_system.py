...
class QuantumQAgent:
    ...
    def __init__(
        self, player_id, learning_rate=0.001, epsilon=0.9, epsilon_decay=0.995, epsilon_min=0.1, memory_size=2000
    ):
        ...
        # 学習統計
        self.training_stats = {"episodes": 0, "total_reward": 0, "losses": [], "epsilon_values": []}
...
class SimpleTournament:
    ...
    def print_rankings(self):
        ...
        for agent_name, stats in self.results.items():
            ...
            print(
                f"{agent_name:15s} | 勝率: {winrate:6.1%} | "
